...
/* ------------------------parsing (end)--------------------------- */
    ...
    document.getElementById("menu4.2").classList.add("current");
    ...
    // build column list
    console.log(items);
    var columnlist = ['Name', 'Gift Capacity', 'Details'];
    ...
    for (var i = 0; items.length > i; i++) {
        ...
        if (currentitem.giftCapacity>0) {
            ...
            htmltablebody += '<td>'+(currentitem.giftCapacity).toLocaleString()+'</td>'; // gift cap
